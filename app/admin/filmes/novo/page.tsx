      ...
      <div className="max-w-3xl mx-auto w-full">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-brand-text-muted mt-1 text-sm">Preencha os detalhes para adicionar um novo filme ao catálogo.</p>
          </div>
        </div>
        ...
        <div className="bg-brand-card border border-white/5 rounded-3xl p-8 shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-xs font-bold text-brand-text-muted uppercase tracking-wider mb-2">URL da Capa (Vertical)</label>
                <input required type="url" name="thumbnailUrl" value={formData.thumbnailUrl} onChange={handleChange} className="w-full bg-brand-bg border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-red/50 transition-colors" placeholder="https://..." />
              </div>

              <div>
                <label className="block text-xs font-bold text-brand-text-muted uppercase tracking-wider mb-2">URL do Banner (Horizontal)</label>
                <input required type="url" name="bannerUrl" value={formData.bannerUrl} onChange={handleChange} className="w-full bg-brand-bg border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-red/50 transition-colors" placeholder="https://..." />
              </div>
