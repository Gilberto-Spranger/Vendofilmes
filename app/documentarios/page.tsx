...
export default function DocumentariosPage() {
  const movies = [...movieCategories.documentarios];
  ...
  return (
    <div className="flex-1 flex flex-col px-4 lg:px-8 py-8 relative w-full">
      <div className="mb-8">
        ...
        <p className="text-brand-text-muted mt-2">Histórias reais que inspiram e surpreendem.</p>
      </div>
